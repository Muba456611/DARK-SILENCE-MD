...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~PANmyRDa#U0olcsTFfCbi1gmVP4gsYl-02-PVGM6usy8HYowPH6U",
    CAPTION: process.env.CAPTION || "POWERED BY ANONYMOUS",
